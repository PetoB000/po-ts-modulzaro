...
console.log("\n\nfesztiválon vannak:", musicFestival.getParticipants());
console.log("\n\nvalaki eventjei:", someone.getRegisteredEvents());


someone.unregisterFromEvent("valami szülinap");
console.log("\n\n Valaki kivétele szülinapból:");
console.log("\n\n szülinapon:", birthdayParty.getParticipants());

console.log("\n\n csoportositás fesztivál szerint:", eventManager.getEventsByTheme(EventType.FESTIVAL));
